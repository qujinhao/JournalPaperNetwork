...
<div class="right-all">
    <div class="right-head">
      <tr>
        ...
        <td><a href="HouTai_qkzs.php" style="text-decoration: none; color: black;">>>期刊知识</a></td>
      </tr>
    </div>
     ...
     <?php
	  ...
	  ?>
        <tr bgcolor="white">
		  ...
		  <td><a href="HouTai_qkzs_edit.php?$id=<?php echo $row['id'];?>" style="text-decoration: none;">编辑</a>&nbsp;&nbsp;&nbsp;<a href="HouTai_qkzs_del.php?$id=<?php echo $row['id'];?>" style="text-decoration: none;">删除</a></td>
        </tr>
        <?php
			}
	 ...
	 <div class="page1">
		 <tr>
			 <td><a href='HouTai_qkzs.php' style="text-decoration: none;  color:black;">首页</a></td>
			 <td><a href='HouTai_qkzs.php?page=<?php echo $ps;?>' style="text-decoration: none;  color:black;">上一页</a></td>
			 <td><a href='HouTai_qkzs.php?page=<?php echo $px;?>' style="text-decoration: none;  color:black;">下一页</a></td>
			 <td><a href='HouTai_qkzs.php?page=<?php echo $page_all_num;?>' style="text-decoration: none;  color:black;">尾页</a></td>
		 </tr>
  </div>
</div>
</div>
