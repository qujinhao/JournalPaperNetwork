...
<div class="detail-right">
    ...
    <div class="qikan_edit_head">
        <tr>
          ...
          <td><a href="HouTai_qikan_insert.php" style="text-decoration: none;  color: #E8ECEF;">添加期刊</a></td>
        </tr>
    </div>
	  <div class="info-all">
		  <div class="info-content">
			  <form method="post" action="HouTai_qikan_insertprocess.php" enctype="multipart/form-data">
				  <table border="1px" height="500" width="93.8%" cellspacing="0" float"left" bordercolor=" #E8ECEF">
					 <tr>
						 <th>刊名：</th>
						  <td><input class="common-text" name="KM" size="30" value="" type="text"></td>
					  </tr>
					  <tr>
						 <th>主办：</th>
						  <td><input class="common-text" name="ZB" size="30" value="" type="text"></td>
					  </tr>
					  <tr>
						 <th>周期：</th>
						  <td><input class="common-text" name="ZQ" size="30" value="" type="text"></td>
					  </tr>
					  <tr>
						 <th>出版地：</th>
						  <td><input class="common-text" name="CBD" size="30" value="" type="text"></td>
					  </tr>
					  <tr>
						 <th>语种：</th>
						  <td><input class="common-text" name="YZ" size="30" value="" type="text"></td>
					  </tr>
					  <tr>
						 <th>开本：</th>
						  <td><input class="common-text" name="KB" size="30" value="" type="text"></td>
					  </tr>
					  <tr>
						 <th>ISSN：</th>
						  <td><input class="common-text" name="ISSN" size="30" value="" type="text"></td>
					  </tr>
					  <tr>
						 <th>CN：</th>
						  <td><input class="common-text" name="CN" size="30" value="" type="text"></td>
					  </tr>
					  <tr>
						 <th>邮发代号：</th>
						  <td><input class="common-text" name="YFDH" size="30" value="" type="text"></td>
					  </tr>
					  <tr>
						 <th>复合影响因子：</th>
						  <td><input class="common-text" name="FHYXYZ" size="30" value="" type="text"></td>
					  </tr>
					  <tr>
						 <th>综合影响因子：</th>
						  <td><input class="common-text" name="ZHYXYZ" size="30" value="" type="text"></td>
					  </tr>
				<tr>
                    <th>所属类型：</th>
                    <td><select name="SULX" class="cs-select"  >
					  ...
					  <tr>
						 <th>添加日期：</th>
						  <td><input class="common-text" name="TJRQ" size="30" value="" type="text"></td>
					  </tr>
					 <tr>
						 <th>图片URL：</th>
						  <td><input class="common-text" name="TPURL" size="30" value="" type="text"></td>
					  </tr>
					  <tr>
						 <th>期刊简介：</th>
					  ...
					  <tr>
                    <th></th>
                    <td ><input class="btn btn-primary" value="添加" type="submit" name="mySent" id="btn-center" >
